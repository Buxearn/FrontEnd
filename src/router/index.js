...
router.beforeEach((to, from, next) => {
  ...
  if (to.meta === "signin" && localStorage.account === undefined)
    next("/signin");
  else if (to.meta === "admin" && localStorage.adminAuth === undefined)
    next("/admin/login");
  else if (to.meta === "reseller" && localStorage.resellerAuth === undefined)
    next("/reseller/login");
  else next();
});
